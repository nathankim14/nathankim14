...
## 📌 Featured Projects
*Explore the repositories below to see my full code, data cleaning processes, and interactive visualizations.*

### 1. ⚾ Baseball Statistics Analysis (Published Web Journal)
...
<!--
**nathankim14/nathankim14** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
